...
function ApplicationDraft({ detail }: { detail: ApplicationDetail }) {
  ...
  useEffect(() => {
    if (!assistantTask || !['queued', 'running'].includes(assistantTask.status)) return;
