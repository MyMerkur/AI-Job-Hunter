...
const applicationSchema = new Schema<ApplicationDocument>({
  ...
  status: { type: String, enum: ['draft', 'prepared', 'reviewed', 'ready_for_review', 'submitted', 'withdrawn', 'rejected', 'interviewing', 'offer', 'applied', 'failed'], default: 'draft', required: true },
